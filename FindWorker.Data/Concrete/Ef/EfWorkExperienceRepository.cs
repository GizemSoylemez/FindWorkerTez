...
{
    public class EfWorkExperienceRepository:EfGenericRepository<WorkExperience>, IWorkExperienceRepository
    {
        public EfWorkExperienceRepository(FindWorkersTezContext context) : base(context)
        {
