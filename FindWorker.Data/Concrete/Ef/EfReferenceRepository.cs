...
{
    public class EfReferenceRepository:EfGenericRepository<Reference>, IReferenceRepository
    {
        public EfReferenceRepository(FindWorkersTezContext context) : base(context)
        {
